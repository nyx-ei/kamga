...
const copy = {
  ...
  fr: {
    ...
    merge: {
      description: 'Absorbez une fiche doublon dans cette fiche canonique en conservant l’historique membres, revendications, parrainages et finance sur la fiche conservée.',
      duplicateLabel: 'Fiche doublon à fusionner',
      mergeAction: 'Fusionner le doublon',
      merged: 'Fiche doublon fusionnée.',
      ...
      warning: 'Cette opération est transactionnelle et doit être utilisée seulement après revue admin.',
      errors: {
        ...
        'KMG-MG-001': 'Sélectionnez deux fiches association différentes.',
        'KMG-MG-404': 'Une des fiches association sélectionnées est introuvable.',
        'KMG-MG-409': 'La fiche doublon a déjà été fusionnée.',
        'KMG-SYS-000': 'Les fiches n’ont pas pu être fusionnées. Réessayez ou contactez le support.'
      }
    },    form: {
      cityLabel: 'Ville',
